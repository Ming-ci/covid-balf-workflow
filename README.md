...
### 全部细胞 UMAP（66,452 个细胞，32 个聚类）

![全部细胞 UMAP](images/1-umap_1.png)

> UMAP 展示了 10 种主要细胞类型的分布。巨噬细胞（红色系，左侧大面积区域）是 BALF 中最丰富的免疫细胞群体，也是 COVID-19 病理研究的关键靶点。T/NK 细胞（蓝色系，右上区域）形成独立的淋巴聚类。每个点代表一个单细胞，颜色对应 Seurat 聚类标签。
